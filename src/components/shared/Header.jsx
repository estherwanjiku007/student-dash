  ...
  return (
    ...
    <div className="bg-white h-16 px-4 flex justify-between items-center border-b border-gray-300">
      ...
      <div className="relative">
        ...
        <HiOutlineSearch
          fontSize={20}
          className="text-gray-400 absolute top-1/2 transform -translate-y-1/2 left-4"
        />
            ...
            <>
              ...
              <Popover.Button
                className={classNames(
                  open && "bg-gray-100",
                  "p-1.5 inline-flex items-center text-gray-700 hover:opacity-100 focus:outline-none active:bg-gray-100"
                )}
              >
              ...
              >
                ...
                <Popover.Panel className="absolute right-0 z-50 mt-2.5 w-80">
                  ...
                  {/* Empty content container with styling */}
                </Popover.Panel>
              </Transition>
            </>
          )}
        ...
        <Menu as="div" className="relative">
          <div>
            <Menu.Button className="ml-2 inline-flex rounded-full">
              ...
              <div
                className="h-10 w-10 rounded-full bg-sky-700 bg-cover bg-no-repeat bg-center"
                style={{
                  backgroundImage:
                    'url("https://img.freepik.com/free-vector/blue-circle-with-white-user_78370-4707.jpg?size=626&ext=jpg&ga=GA1.1.1937966505.1715260267&semt=ais_user_b")',
                }}
              >
          ...
          >
            <Menu.Items className="origin-top-right z-50 absolute right-0 mt-2 w-48 rounded-sm shadow-md p-1 bg-white ring-black ring-opacity-5 focus:outline-none">
              <Menu.Items>
                {({ active }) => (
                  <div
                    className={classNames(
